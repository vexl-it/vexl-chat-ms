...
class ChallengeServiceIT {
    ...
    void testCreatingBatchChallengesSignThemAndVerifyThem_v2_shouldBeCreatedSignedAndVerified() {
        ...
        final String signatureA = CLibrary.CRYPTO_LIB.ecdsa_sign_v2(PUBLIC_KEY_USER_A, PRIVATE_KEY_USER_A, challengeForA, challengeForA.length());
        final String signatureB = CLibrary.CRYPTO_LIB.ecdsa_sign_v2(PUBLIC_KEY_USER_B, PRIVATE_KEY_USER_B, challengeForB, challengeForB.length());
